...
class TestDemotest():
    ...
    def wait_test_screenshot(self):
        ...
        while (True):
            print("begin to wait 30m for take screenshot for each site")
            time.sleep(18)
            for i in range(0, 5):
...
if __name__ == '__main__':
    ...
    try:
        _thread.start_new_thread(testd.wait_and_sleep,())
        print("thread-1")
        _thread.start_new_thread(testd.wait_test_screenshot,())
        print("thread-2")
